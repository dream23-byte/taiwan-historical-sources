...
- ✅ **修正事件 56 前因鏈經史料查證**（2026-08-27）：使用者記憶主框架正確，但細節修正——(1) 荷蘭 1622 是**先攻澳門失利**才轉佔澎湖築風櫃城（非直接為搶市場）；(2) 1623–24 福建巡撫南居益發動**風櫃圍城戰**（萬兵二百船圍城七月），荷軍非戰敗潰退，而是經**李旦調停**協議拆城退出、明朝默許轉往大員。desc 已改為查證版本
- ✅ **因果鏈資料品質修正（C 任務，2026-08-27）**：掃描全表清除 4 筆自我引用
  - id 40 甲午戰爭：effects 去除自我，保留 `[41]`（八國聯軍）
  - id 77 二戰結束與聯合國：effects 去除自我，保留 `[78,79,82,83]`
  - id 69 馬丁路德宗教改革：effects 改 `[91]`（三十年戰爭，史料確證宗教改革→宗教戰爭）
  - id 70 麥哲倫環球航行：causes 改 `[89,90]`（君士坦丁堡陷落＋文藝復興，史料確證陸路受阻→尋海路）
  - 最終驗證：自我引用＝0、循環引用＝0、陣列重複 id＝0
