...
## 當前進度（2026-08-01）
- **全庫 1220 筆**：臺灣 516／中國 465／港澳 32／琉球 30／日本 40／韓國 40／東南亞 60／印度 37
- sources 1–1313・periods 1–73・institutions 1–357，全部已匯入 Supabase
- 前端標題動態顯示「73 時期 · 1220 筆」（不需改 code）
...
| 十 | 🔄 | 南亞（印度已完成；巴基斯坦/孟加拉/斯里蘭卡/尼泊爾待續） | sources 1277–1313 |
...
└── sources/
    ...
    ├── 港澳/ 琉球/ 日本/ 韓國/ 東南亞/ 印度/  # 各區域 metadata CSV＋檢測報告
```
